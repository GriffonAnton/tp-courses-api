...
API REST pour gérer des cours et des catégories avec authentification.
...
- Les utilisateurs ont un rôle : admin, instructor ou user.
...
- POST /auth/login : Se connecter et récupérer un token

### Categories
- GET /categories : Récupérer toutes les catégories (pas besoin de token)
- GET /categories/:id : Récupérer une catégorie par ID (pas besoin de token)
- POST /categories : Créer une catégorie (Admin uniquement)

### Cours
- GET /courses : Récupérer tous les cours (pas besoin de token)
- GET /courses/:id : Récupérer un cours par ID (pas besoin de token)
- POST /courses : Créer un cours (Instructor uniquement)
- PUT /courses/:id : Modifier un cours (Instructor du cours uniquement)
- DELETE /courses/:id : Supprimer un cours (Admin uniquement)

## Swagger Documentation
La documentation se trouve sur /api-docs dans le navigateur.
